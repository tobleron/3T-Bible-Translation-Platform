...
`src/ttt_workbench/templates/partials/workspace_shell.html` is a `template` file with an estimated risk score of `7.93`.

## Metrics

- LOC: `2062` (preferred `260`, hard ceiling `420`)
- Language: `template`
- Branches: `0`
- Max nesting: `0`
...
- `medium` `size`: 2062 LOC exceeds preferred 260 LOC for role `template`.
- `high` `size`: 2062 LOC exceeds hard ceiling 420 LOC for role `template`.
