...
`src/ttt_workbench/static/app.css` is a `style` file with an estimated risk score of `2.72`.

## Metrics

- LOC: `2452` (preferred `900`, hard ceiling `1400`)
- Language: `css`
- Branches: `0`
- Max nesting: `0`
...
- `medium` `size`: 2452 LOC exceeds preferred 900 LOC for role `style`.
- `high` `size`: 2452 LOC exceeds hard ceiling 1400 LOC for role `style`.
