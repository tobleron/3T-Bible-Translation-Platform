...
class ChapterChunkBatch:
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.paths = ProjectPaths(repo_root=self.repo_root)
  ...
  mixed""".strip()
    ...
    def validate_payload(self, payload: dict[str, Any], target: ChapterTarget) -> list[dict[str, Any]]:
        ...
        for index, item in enumerate(chunks, start=1):
            ...
            chunk_type = TYPE_ALIASES.get(chunk_type, chunk_type)
...
def parse_args() -> argparse.Namespace:
    default_output_dir = REPO_ROOT / "output" / "ai_sessions" / "chapter_chunk_catalog"
