...
This script reads approved chapter-level chunk catalogs and writes one aggregate
JSON file per book. The source chapter files remain untouched so the
aggregation can be rerun safely after partial or full update passes.
"""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    default_source_dir = REPO_ROOT / "data" / "final" / "chapter_chunk_catalog" / "chunks"
    default_output_dir = REPO_ROOT / "data" / "final" / "chapter_chunk_catalog" / "books"
