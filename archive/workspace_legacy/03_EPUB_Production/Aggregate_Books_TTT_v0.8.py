...
===================================================
* Scans all chapter JSON files under `_HOLY_BIBLE`.
...
* Output saved to `_Complete_JSON/TTT_flat_bible_v0.8_<DDMMYYYY_HHMM>.json`.
...
HOLY_DIR    = ROOT / '_HOLY_BIBLE'
OUTPUT_DIR  = ROOT / '_Complete_JSON'
